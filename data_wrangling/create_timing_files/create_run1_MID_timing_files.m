...
savedir = '/home/zach/Documents/current_projects/ACNlab/BrainMAPD/timing/consumption/all_trial_types';
clear onsets names durations
...
for sub = 1:242
    ...
    % start with anticipation because it's a little easier
    trial_type_strings = {'congain_1.5','congain_5','congain_0','conloss_1.5','conloss_5','conloss_0', 'congain_all','conloss_all','motor_all'};
    for files = 1:length(trial_type_strings)
