...
if nargin==0 % defaults just for testing
    ...
    directories{1} = '/Users/zaz3744/Documents/current_projects/ACNlab/BrainMAPD/func_conn/PPI/ppi_fldir/anticipation_hovmpfc';
    ...
    directories{4} = '/Users/zaz3744/Documents/current_projects/ACNlab/BrainMAPD/func_conn/PPI/mdl_dir/anticipation/HOvmPFC';
    PID = '20518';  
    overwrite = 1;
    ses = 2;
    mask_string = 'HOAccumbens';
    run = 1;
end
