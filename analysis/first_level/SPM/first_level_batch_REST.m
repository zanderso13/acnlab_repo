...
scriptdir = '/projects/b1108/projects/BrainMAPD_func_conn/first_levels/sarah_first_level_output/quest_submission';
...
%     run_subject_firstlevel_REST(ids,ses,run,overwrite)
     ...
     '#SBATCH -t 00:10:00\n'...  
     '#SBATCH --mem=30G\n\n'...
     'matlab -nodisplay -nosplash -nodesktop -r "addpath(genpath(''' repodir ''')); run_subject_firstlevel_REST(' num2str(ids) ', ' num2str(ses) ',' num2str(run) ',' num2str(overwrite) '); quit"\n\n'];
