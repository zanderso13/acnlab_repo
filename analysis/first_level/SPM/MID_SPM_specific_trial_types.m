...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Gain5-Gain0';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1 0 -1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Gain150-Gain0';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [0 1 -1];
matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'Loss5-Loss0';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.weights = [0 0 0 0 1 -1];
matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'Loss150-Loss0';
